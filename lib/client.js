window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		// ── mushroom-cloud glyph (the "consumption" mark beside the balance) ──
		function MushroomIcon() {
			return react.createElement("svg", {
				...
				react.createElement("g", { fill: "currentColor" },
					react.createElement("circle", { cx: 4.8, cy: 6, r: 2.1 }),
					react.createElement("circle", { cx: 7.3, cy: 4.7, r: 2.5 }),
					react.createElement("circle", { cx: 10.1, cy: 4.9, r: 2.3 }),
					react.createElement("circle", { cx: 12, cy: 6.3, r: 1.8 }),
					react.createElement("rect", { x: 3.2, y: 5.4, width: 9.6, height: 2.7, rx: 1.3 }),
					react.createElement("rect", { x: 7, y: 7.2, width: 2, height: 4.6, rx: 0.9 }),
					react.createElement("rect", { x: 5, y: 11.8, width: 6, height: 1.5, rx: 0.75 })));
		}
