...
// (symlinks/junctions resolving outside are rejected). The project's
// read-only backup directory (反重力备份) rejects all mutations.
...
function apply(ctx, config) {
  ...
  const protectedDirs = roots.map((r) => join(r, "反重力备份"));
